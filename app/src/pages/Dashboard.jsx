  ...
  <>
    ...
    <main>
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <iframe title="Wep" width="1024" height="612" src="https://app.powerbi.com/view?r=eyJrIjoiOTNlNDgwNjItZGI4OS00NDkwLWE1YTAtMjYyOTMzYmJlOWNmIiwidCI6IjNjNGJjZjZhLTQzOTQtNDI1OC05YjVkLWZlMmZkMTg4MGFjYiIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe>
